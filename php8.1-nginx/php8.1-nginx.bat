...
docker build -t php:8.1.18-fpm-custom .
...
docker run --name php1 --network lnmp-net --network-alias lnmp-net --restart always -p 9000:9000 -v %dirPath%:/var/www/html -d php:8.1.18-fpm-custom
